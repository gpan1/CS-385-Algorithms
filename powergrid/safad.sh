...
run_test_args "graph.txt" $'Total wire length (meters): 240\nApple Rd. [50]\nSummit Ave. [90]\nZebra St. [100]'
rm -f graph.txt
...
run_test_args "graph.txt" $'Total wire length (meters): 255\nApple Rd. [50]\nMadison St. [15]\nSummit Ave. [90]\nZebra St. [100]'
rm -f graph.txt
...
run_test_args "graph.txt" $'Total wire length (meters): 905\nApple Rd. [50]\nDrake Ln. [150]\nLake Rd. [500]\nMadison St. [15]\nSummit Ave. [90]\nZebra St. [100]'
rm -f graph.txt
...
# EOF
# ) > graph.txt
# run_test_args "graph.txt" "Error: Invalid edge data '1,2,,Maple Ave.' on line 2."
# rm -f graph.txt
